...
export class TalentsTabComponent {
  ...
  setTalent(i: number, field: keyof TalentFormData, value: any): void {
    this.talents.update(t => t.map((ta, idx) => idx === i ? { ...ta, [field]: value } : ta));
  }
  onTalentIconSelect(i: number, event: Event): void {
