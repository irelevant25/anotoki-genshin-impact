...
})->add(validateRequest(CharacterAscension::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(validateRequest(CharacterAscension::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
