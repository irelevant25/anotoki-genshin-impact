...
})->add(validateRequest(EnemyDamageTypeElement::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(validateRequest(EnemyDamageTypeElement::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
