...
})->add(validateRequest(CharacterBuild::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(validateRequest(CharacterBuild::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
