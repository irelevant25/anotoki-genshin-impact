...
})->add(responds('characters_builds', list: true));
...
})->add(responds('characters_builds'));
...
})->add(responds('characters_builds'))->add(validateRequest(CharacterBuild::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(responds('characters_builds'))->add(validateRequest(CharacterBuild::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(responds('characters_builds'))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
