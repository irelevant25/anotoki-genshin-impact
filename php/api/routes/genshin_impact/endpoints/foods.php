...
})->add(validateRequest(Food::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(validateRequest(Food::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
