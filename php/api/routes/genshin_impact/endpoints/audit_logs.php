...
})->add(responds(AuditLogFilters::class))->add(requireRole(...ROLES_SYSTEM_READ))->add(requireAuth());
...
})->add(responds(AuditLogPage::class))->add(requireRole(...ROLES_SYSTEM_READ))->add(requireAuth());
