...
// GET all character constellations
$app->get('/api/characters-constellations', function (Request $request, Response $response) {
    $items = DbQuery::from(genshinDb(), 'characters_constellations')
