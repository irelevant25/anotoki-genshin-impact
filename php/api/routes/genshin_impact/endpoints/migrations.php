...
})->add(responds(MigrationEntry::class, list: true))->add(requireRole(...ROLES_SYSTEM_READ))->add(requireAuth());
...
})->add(responds(MigrationFile::class))->add(requireRole(...ROLES_SYSTEM_READ))->add(requireAuth());
