...
})->add(responds('regions', list: true));
...
})->add(responds('regions'))->add(validateRequest(Region::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(responds('regions'))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
