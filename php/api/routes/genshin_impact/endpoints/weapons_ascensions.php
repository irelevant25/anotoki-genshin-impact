...
})->add(validateRequest(WeaponAscension::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(validateRequest(WeaponAscension::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
