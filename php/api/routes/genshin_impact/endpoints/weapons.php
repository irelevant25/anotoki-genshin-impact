...
})->add(validateRequest(Weapon::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(validateRequest(Weapon::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
