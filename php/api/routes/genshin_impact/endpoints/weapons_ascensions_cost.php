...
})->add(responds('weapons_ascensions_cost', list: true));
...
})->add(responds('weapons_ascensions_cost'));
...
})->add(responds('weapons_ascensions_cost'))->add(validateRequest(WeaponAscensionCost::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(responds('weapons_ascensions_cost'))->add(validateRequest(WeaponAscensionCost::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(responds('weapons_ascensions_cost'))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
