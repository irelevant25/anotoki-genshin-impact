...
})->add(validateRequest(WeaponAscensionCost::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(validateRequest(WeaponAscensionCost::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
