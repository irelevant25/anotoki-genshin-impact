...
})->add(responds('banners_characters', list: true));
...
})->add(responds('banners_characters'));
...
})->add(responds('banners_characters'))->add(validateRequest(BannerCharacter::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(responds('banners_characters'))->add(validateRequest(BannerCharacter::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(responds('banners_characters'))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
