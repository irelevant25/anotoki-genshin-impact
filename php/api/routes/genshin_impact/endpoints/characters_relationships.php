...
})->add(validateRequest(CharacterRelationship::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(validateRequest(CharacterRelationship::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
