...
})->add(responds('characters_builds_artifacts', list: true));
...
})->add(responds('characters_builds_artifacts'));
...
})->add(responds('characters_builds_artifacts'))->add(validateRequest(CharacterBuildArtifact::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(responds('characters_builds_artifacts'))->add(validateRequest(CharacterBuildArtifact::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(responds('characters_builds_artifacts'))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
