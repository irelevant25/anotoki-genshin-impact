...
})->add(validateRequest(CharacterBuildTeam::class))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
...
})->add(validateRequest(CharacterBuildTeam::class, true))->add(requireRole(...ROLES_CONTENT))->add(requireAuth());
